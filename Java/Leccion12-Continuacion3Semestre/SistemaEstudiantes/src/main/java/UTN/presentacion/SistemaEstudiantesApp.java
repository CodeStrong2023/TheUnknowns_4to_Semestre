...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        var salir = false; //A esto ya lo hicimos antes
    ...
    //Metodo ejecutarOpciones
    //Este metodo va a regresar un valor booleano, ya que es el que puede modificar el valor
    ...
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDAO){
        ...
        switch (opcion){
            ...
            case 3 -> { //Agregar estudiante
                ...
                var agregado = estudianteDAO.agregarEstudiantes(estudiante);
                if (agregado)
            ...
            default -> System.out.println("Opción no reconocida, ingrese otra opción"); //Por si el usuario preciona otro numero, lo vuelve al menu
        }//Fin switch
        return salir;
